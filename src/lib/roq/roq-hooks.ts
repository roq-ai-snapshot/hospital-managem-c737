...
export function useDoctorFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDoctorFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.doctor.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDoctorCount<T extends Prisma.doctorCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.doctorCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useDoctorCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.doctor.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDoctorFindManyWithCount<
  T extends Prisma.doctorFindManyArgs,
  R extends { data: GetFindResult<Prisma.$doctorPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.doctorFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDoctorFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.doctor.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useDoctorFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useDoctorFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.doctor.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHospitalFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useHospitalFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hospital.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHospitalCount<T extends Prisma.hospitalCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.hospitalCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useHospitalCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hospital.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHospitalFindManyWithCount<
  T extends Prisma.hospitalFindManyArgs,
  R extends { data: GetFindResult<Prisma.$hospitalPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.hospitalFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useHospitalFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hospital.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHospitalFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useHospitalFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hospital.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
