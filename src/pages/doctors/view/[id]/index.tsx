...
import { useDoctorFindFirst, useRoqClient } from 'lib/roq';

import { DoctorInterface } from 'interfaces/doctor';
import { AppointmentListPage } from 'pages/appointments';
import { MedicalRecordListPage } from 'pages/medical-records';
...
function DoctorViewPage() {
  ...
  const { data, error, isLoading } = useDoctorFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('doctor', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/doctors/edit/${id}`} passHref legacyBehavior>
                    <Button
