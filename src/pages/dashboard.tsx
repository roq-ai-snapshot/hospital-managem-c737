...
import { useRoqPlatformUserProfiles, usePatientCount, useAppointmentCount, useMedicalRecordCount } from 'lib/roq';

import { MedicalRecordListPage as ShowCaseList } from 'pages/medical-records';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`medical-records`} passHref legacyBehavior>
                  <Button
