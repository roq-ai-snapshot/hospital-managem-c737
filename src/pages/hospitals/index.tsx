...
import { useRoqClient, useHospitalFindManyWithCount } from 'lib/roq';
...
export function HospitalListPage(props: HospitalListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useHospitalFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.hospital.delete({ where: { id } });
      await mutate();
    } catch (error) {
